...
final class CameraConfigurationManager {
	...
	public void initFromCameraParameters(Camera camera) {
		...
		mScreenResolution = new Point(display.getWidth(), display.getHeight());// 灞忓箷瀹藉害楂樺害
	...
	/**
	 * 
	 * setCameraParametersForPreviewCallBack:璁剧疆鍙傛暟(鐢ㄤ簬瀹炴椂棰勮鏁版嵁鍥炴帀). <br/>
	 * 
	 * @author:284891377 Date: 2016骞�7鏈�11鏃� 涓嬪崍2:53:05
	 * @param camera
	 * @param previewW
	 *            寤鸿640
	 * @param previewH
	...
	/**
	 * 
	 * getOptimalPreviewSize:鑾峰彇鏈�鎺ヨ繎棰勮鍒嗚鲸鐜� <br/>
	 * 
	 * @author:284891377 Date: 2016骞�7鏈�11鏃� 涓嬪崍2:51:06
	 * @param localList
	 * @param w
	 * @param h
	 * @return
